...
public class ApiErrorHandler {
    ...
    ResponseEntity<ErrorEnvelope> invalidRequest(Exception exception, HttpServletRequest request) {
        return response(HttpStatus.BAD_REQUEST, "VALIDATION_FAILED", "请求参数不合法", false, Map.of(), request);
    }

    @ExceptionHandler({NoHandlerFoundException.class, NoResourceFoundException.class})
    ResponseEntity<ErrorEnvelope> notFound(Exception exception, HttpServletRequest request) {
    ...
    ResponseEntity<ErrorEnvelope> capabilityUnavailable(
    ...
    ResponseEntity<ErrorEnvelope> applicationFailure(
    ...
    ResponseEntity<ErrorEnvelope> domainRejection(DomainException exception, HttpServletRequest request) {
    ...
    private ResponseEntity<ErrorEnvelope> response(
        ...
        return ResponseEntity.status(status)
                ...
                .body(new ErrorEnvelope(new ApiError(code, message, retryable, correlationId(request), details)));
    }
