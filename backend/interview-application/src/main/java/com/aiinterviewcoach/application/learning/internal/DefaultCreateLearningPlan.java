...
import com.aiinterviewcoach.application.learning.CreateLearningPlan;
import com.aiinterviewcoach.application.learning.LearningPlanRepository;
import com.aiinterviewcoach.application.learning.LearningPolicyPort;
import com.aiinterviewcoach.application.learning.LearningSourceAccessPort;
...
import com.aiinterviewcoach.domain.learning.LearningTask;
...
public final class DefaultCreateLearningPlan implements CreateLearningPlan {
    ...
    private LearningSourceAccessPort.Source loadSource(
            Command command, com.aiinterviewcoach.domain.platform.PrincipalRef owner) {
    ...
    private Result replay(Command command, com.aiinterviewcoach.domain.platform.PrincipalRef owner,
    ...
    private static void requireSameOwner(
            com.aiinterviewcoach.domain.platform.PrincipalRef expected,
            com.aiinterviewcoach.domain.platform.PrincipalRef actual) {
