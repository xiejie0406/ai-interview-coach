...
import com.aiinterviewcoach.domain.interview.QuestionPrompt;
...
public final class DefaultProgressInterview implements ProgressInterview {
    ...
    private final com.aiinterviewcoach.application.voice.port.ContentDigestPort digest;
    ...
    public DefaultProgressInterview(
            ...
            com.aiinterviewcoach.application.voice.port.ContentDigestPort digest
    ) {
    ...
    public InterviewSessionSnapshot handle(Command command) {
        ...
        return transaction.required(() -> {
            ...
            var current = session.turns().isEmpty()
                    ? Optional.<com.aiinterviewcoach.domain.interview.InterviewTurn>empty()
                    : Optional.of(session.turns().getLast());
            ...
            if (candidate.isPresent() && current.isPresent()
                ...
                session.commitQuestion(turnId, new QuestionPrompt(followUp, digest.digest(followUp),
                                Optional.of(new com.aiinterviewcoach.domain.platform.PromptRef(
                                        new com.aiinterviewcoach.domain.platform.ImmutableVersionRef(
                                                com.aiinterviewcoach.domain.platform.ResourceId.of("interview-agent-prompt-v1"), 1,
                                                "interview-agent-prompt-v1"))),
                                Optional.of(new com.aiinterviewcoach.domain.platform.SchemaRef(
                                        new com.aiinterviewcoach.domain.platform.ImmutableVersionRef(
                                                com.aiinterviewcoach.domain.platform.ResourceId.of("interview-agent-schema-v1"), 1,
    ...
    private Optional<String> prepareAgentCandidate(Command command) {
        ...
        var turn = session.turns().getLast();
    ...
    private void save(com.aiinterviewcoach.domain.interview.InterviewSession session) {
