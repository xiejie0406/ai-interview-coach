...
import com.aiinterviewcoach.application.catalog.RetireQuestion;
...
public final class DefaultRetireQuestion implements RetireQuestion {
    ...
    public Result handle(Command command) {
        return transaction.required(() -> {
            ...
            String requestHash = ServerSideDigest.sha256("catalog.question.retire", command.questionId().value(),
