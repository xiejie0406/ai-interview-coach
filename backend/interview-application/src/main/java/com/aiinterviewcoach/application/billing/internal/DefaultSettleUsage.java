...
import com.aiinterviewcoach.application.billing.SettleUsage;
...
import com.aiinterviewcoach.domain.platform.ServiceActorRef;
        ...
        return transaction.required(() -> {
            ...
            if (decision.type() == IdempotencyGuard.DecisionType.REPLAY_SUCCESS) {
                ...
                return new Result(BillingViews.reservation(reservation),
                        com.aiinterviewcoach.domain.platform.ResourceId.of(settlementId));
            }
            ...
            if (!entitlement.userId().equals(reservation.userId())) {
                throw new DomainException(com.aiinterviewcoach.domain.platform.DomainErrorCode.OWNERSHIP_DENIED,
