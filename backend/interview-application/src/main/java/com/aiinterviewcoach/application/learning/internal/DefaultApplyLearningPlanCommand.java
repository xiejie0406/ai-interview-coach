...
import com.aiinterviewcoach.application.learning.ApplyLearningPlanCommand;
...
public final class DefaultApplyLearningPlanCommand implements ApplyLearningPlanCommand {
    ...
    private LearningPlan ownedPlan(com.aiinterviewcoach.domain.platform.PrincipalRef owner,
                                   com.aiinterviewcoach.domain.platform.ResourceId planId) {
