...
-- menu_id 2000-2010 为本增量保留段；若既有数据占用其中 ID，迁移会跳过该项，
-- 管理员需先分配不冲突的 menu_id 并按业务角色写入 sys_role_menu。
...
from (
    ...
    union all select 2010, 'Question review', 11, 'interview:question:review'
) v
