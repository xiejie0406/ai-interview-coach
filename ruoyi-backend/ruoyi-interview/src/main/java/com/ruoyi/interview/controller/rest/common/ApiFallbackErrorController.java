...
public final class ApiFallbackErrorController implements ErrorController {
    ...
    public ResponseEntity<AjaxResult> error(HttpServletRequest request) {
        ...
        AjaxResult envelope = AjaxResult.error(status.value(), descriptor.message());
        envelope.put("errorCode", descriptor.code());
        envelope.put("retryable", descriptor.retryable());
