...
> 风险等级：L3
> 产出阶段：5 技术设计
> 阶段状态：Completed（设计门）；阶段 7 实施由 PHASE-19 跟踪
> 关联：[`../specs/README.md`](../specs/README.md)、[`../phases/phase-19-ruoyi-platform-convergence.md`](../phases/phase-19-ruoyi-platform-convergence.md)、[`technical-architecture.md`](technical-architecture.md)、[`ruoyi-migration-plan.md`](ruoyi-migration-plan.md)、[`../../backend/pom.xml`](../../backend/pom.xml)、[`../../apps/platform-backend/pom.xml`](../../apps/platform-backend/pom.xml)
...
2. `backend/` 的独立 Spring Boot 单体迁入 `apps/platform-backend/`，最终只保留一个 RuoYi 后端进程。
...
- 当前实现状态、实际文件差异和未执行验证由 [`../development-records/2026-08-16-ruoyi-convergence-wave-01.md`](../development-records/2026-08-16-ruoyi-convergence-wave-01.md) 记录。
