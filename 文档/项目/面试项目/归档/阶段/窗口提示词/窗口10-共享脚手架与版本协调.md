...
先检查激活条件：
1. 找到 Approved 的 Phase 01 Feature 控制页、技术设计.md、任务清单.md 和执行包。
...
完整读取：项目/用户 AGENTS.md、项目规范索引、上述 Approved Feature 包、docs/phases/第01期-独立工程契约与模块边界地基.md、多窗口并行开发计划.md、计划文件结构蓝图.md、环境说明和 development/quality/architecture 规范。

独占允许范围（最终以 任务清单.md 为准）：
- pom.xml
- backend/pom.xml
