...
完整读取：项目/用户 AGENTS.md、docs/specs/README.md、docs/product/产品需求文档.md、docs/phases/README.md、依赖覆盖与负责人矩阵.md、十八期路线审查清单.md、代码落地完整性与开发就绪审查.md、phase-01 至 phase-18，以及 agent-governance、quality-delivery-spec、development-spec、documentation-spec。

独占输出：
docs/phases/就绪定义验证与验收计划.md
