...
必须先完整读取用户级 AGENTS/spec、项目 AGENTS、docs/specs/README.md、实施技术契约候选包.md、代码落地就绪审查.md，并确认当前仍是 L3 / 阶段 3 WaitingForApproval / NotRun。
...
禁止修改：
- domain、application、contracts、frontend、POM、测试代码、docs/product、docs/architecture/技术架构.md、docs/phases/phase-*.md。
