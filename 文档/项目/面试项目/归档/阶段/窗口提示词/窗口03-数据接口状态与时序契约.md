...
完整读取：项目/用户 AGENTS.md、docs/specs/README.md、docs/product/产品需求文档.md、docs/architecture/技术架构.md、docs/phases/技术架构审查与边界深化.md、依赖覆盖与负责人矩阵.md、计划文件结构蓝图.md、代码落地完整性与开发就绪审查.md，以及 architecture-spec、development-spec、feature-spec、documentation-spec。
