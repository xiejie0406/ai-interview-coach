...
必须完整读取：项目/用户 AGENTS.md、docs/specs/README.md、docs/product/产品需求文档.md、docs/product/面试教练与题库调研.md、docs/review/产品全量审计与权威规格恢复候选.md、docs/decisions/决策登记表.md、docs/phases/代码落地完整性与开发就绪审查.md，以及 product-spec、feature-spec、agent-governance、documentation-spec。
...
禁止修改：docs/product/产品需求文档.md、docs/architecture/技术架构.md、docs/decisions/决策登记表.md、docs/phases/**、任何源码。
