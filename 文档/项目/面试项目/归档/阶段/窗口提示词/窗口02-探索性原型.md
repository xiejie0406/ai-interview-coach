...
完整读取：项目/用户 AGENTS.md、docs/specs/README.md、docs/product/产品需求文档.md、docs/review/产品全量审计与权威规格恢复候选.md、docs/phases/README.md、docs/phases/代码落地完整性与开发就绪审查.md、docs/phases/phase-03 至 phase-15 的相关页面/状态描述，以及 product-spec、feature-spec、documentation-spec。

独占输出目录：
docs/prototypes/FEAT-INTERVIEW-001/

至少创建：
- 探索性原型审计.md：用户旅程、页面地图、交互决定、评审入口
- 原型状态矩阵.md：每页默认/已有、空/加载、校验/系统/外部失败、无权限/拒绝/取消、超时/重复/恢复/完成
