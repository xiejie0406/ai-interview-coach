...
> 文档类型：Phase / 执行提示模板
> 文档状态：Draft
> owner / 责任边界：platform / interview / frontend；本文件只编排 `TASK-RUOYI-03/04` 的语音切片，不替代 Canonical Feature Spec、设计或 `任务清单.md`
> 创建时间：2026-08-23
> 更新时间：2026-08-23
...
> 证据结果：NotRun
> 关联：[`../../architecture/若依平台收敛设计.md`](../../../架构/若依集成/若依身份与后端单体收敛设计.md)、[`../第19期-若依身份与后端单体收敛.md`](../第19期-若依身份与后端单体收敛.md)、[`../../development-records/2026-08-23-若依语音面试迁移.md`](../../../开发记录/若依集成/2026-08-23-若依语音面试迁移.md)
...
4. 项目事实源：
   ...
   - `docs/architecture/若依平台收敛设计.md`（已批准的 RuoYi 收敛事实源）
   - `docs/phases/第19期-若依身份与后端单体收敛.md`
   - `docs/development-records/2026-08-23-若依语音面试迁移.md`
   - `docs/development-records/2026-08-23-若依收敛-批次02.md`
   - `docs/reference/最小可行产品迁移状态与待办.md`
...
7. `docs/architecture/技术架构.md` 中旧 Cookie 身份语义与已批准 RuoYi 设计冲突时，以 `若依平台收敛设计.md` 为准；不要在本任务顺手重写整份历史 Draft。
