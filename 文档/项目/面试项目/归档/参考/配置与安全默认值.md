...
> 2026-09-10 阅读提示：本文是已删除旧 `backend/` 的 Foundation 配置快照；当前 RuoYi 配置入口为 [`../../platform-backend/ruoyi-admin/src/main/resources/application.yml`](../../../../../platform-backend/ruoyi-admin/src/main/resources/application.yml)。
...
> 历史关联：`backend/interview-boot/src/main/resources/application.yaml`；当前环境变量示例：[`../../.env.example`](../../../../../.env.example)
