...
> 2026-09-10 阅读提示：本文是已删除旧 `backend/` 的 Foundation 配置快照；当前 RuoYi 配置入口为 [`ruoyi-backend/ruoyi-admin/src/main/resources/application.yml`](../../../../../ruoyi-backend/ruoyi-admin/src/main/resources/application.yml)。
