...
public final class DefaultConfirmInterviewPlan implements ConfirmInterviewPlan {
    ...
    @Override
    public com.ruoyi.interview.application.interview.InterviewPlanView handle(Command command) {
        return transaction.required(() -> {
            ...
            if (!plan.usageEstimate().ruleVersion().equals(command.acknowledgedEstimateVersion())) {
                throw new com.ruoyi.interview.domain.platform.DomainException(
                        com.ruoyi.interview.domain.platform.DomainErrorCode.VERSION_CONFLICT,
