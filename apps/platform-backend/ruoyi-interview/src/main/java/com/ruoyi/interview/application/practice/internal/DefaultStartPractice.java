...
import com.ruoyi.interview.application.practice.StartPractice;
    ...
    public PracticeAttemptView handle(Command command) {
        return transaction.required(() -> {
            ...
            if (decision.type() == IdempotencyGuard.DecisionType.REPLAY_SUCCESS) {
                ...
                return repository.find(owner.tenantId(), com.ruoyi.interview.domain.platform.ResourceId.of(attemptId))
