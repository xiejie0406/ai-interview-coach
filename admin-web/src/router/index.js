...
export const constantRoutes = [
  ...
  },
  {
    ...
    component: Layout,
    redirect: '/interview-management/dashboard',
    name: 'InterviewManagement',
    meta: { title: 'AI 面试管理', icon: 'education' },
    children: [
      {
        path: 'dashboard',
        component: () => import('@/views/interview/dashboard/index.vue'),
        name: 'InterviewDashboard',
        meta: { title: '业务总览', icon: 'dashboard' }
      },
      {
        path: 'catalog',
        component: () => import('@/views/interview/catalog/index.vue'),
        name: 'InterviewCatalog',
        meta: { title: '面试题库', icon: 'documentation' }
      },
      {
        path: 'voice',
        component: () => import('@/views/interview/voice/index.vue'),
        name: 'InterviewVoice',
        meta: { title: '语音面试', icon: 'microphone' }
      }
    ]
  }
]
